...
This package provides two main geoms, `geom_ridgeline` and `geom_joy`. The former takes height values directly to draw ridgelines, and the latter first estimates data densities and then draws those using ridgelines.
